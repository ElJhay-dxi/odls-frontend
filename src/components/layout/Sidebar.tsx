...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Plant Lines', icon: <Cable />, path: '/master/plant-lines', permission: 'master.view' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Environmental Monitoring', icon: <Park />, path: '/lab/environmental', permission: 'lab.environmental.view' },
