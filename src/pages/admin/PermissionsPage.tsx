import {
  ...
  Alert, Typography, Divider, Chip, Stack, MenuItem,
...
import { Add, Edit, Delete, Save, Security } from '@mui/icons-material';
...
const GROUPS = [
  ...
  'Station Logs', 'Chemical Lab', 'Reports', 'User Management',
];
            ...
            Object.entries(grouped).map(([group, perms]) => (
              <Box key={group} sx={{ mb: 3 }}>
                <Typography variant="caption"
                  sx={{ fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1, color: 'text.secondary', mb: 1, display: 'block' }}>
                  {group} ({perms.length})
                </Typography>
      ...
      <Dialog open={dialogOpen} onClose={closeDialog} maxWidth="xs" fullWidth>
        ...
        <DialogActions sx={{ px: 3, py: 2 }}>
          <Stack direction="row" spacing={1.5}>
            <Button variant="outlined" onClick={closeDialog} disabled={saving}>Cancel</Button>
